...
function ContactForm() {
  ...
  if (status === 'success') {
    return (
      ...
      >
        ...
        <h3 className="text-2xl font-black text-navy-900 mb-2">Nachricht gesendet!</h3>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      {/* Topic selection */}
      <div>
        <label className="block text-sm font-semibold text-navy-900 mb-2">Ihr Anliegen *</label>
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="w-full border border-slate-200 rounded-xl px-4 py-3 text-slate-900 placeholder:text-slate-400 focus:border-aqua-500 focus:ring-2 focus:ring-aqua-100 outline-none transition-all text-sm"
          />
        </div>
        <div>
      ...
      {/* Phone */}
      <div>
        <label className="block text-sm font-semibold text-navy-900 mb-1.5">Telefon</label>
        <input
          type="tel"
          name="phone"
      ...
      <div className="bg-aqua-50 border border-aqua-100 rounded-2xl p-4">
        <p className="text-aqua-700 font-semibold text-sm mb-3">
          Optional: Für eine bessere Empfehlung
        </p>
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
            <label className="block text-xs font-medium text-slate-600 mb-1">Personen im Haushalt</label>
            <input
              type="number"
              name="persons"
              min="1"
              ...
              onChange={handleChange}
              placeholder="z.B. 4"
              className="w-full border border-aqua-200 bg-white rounded-xl px-4 py-2.5 text-slate-900 placeholder:text-slate-400 focus:border-aqua-500 focus:ring-2 focus:ring-aqua-100 outline-none text-sm"
            />
          </div>
          <div>
            <label className="block text-xs font-medium text-slate-600 mb-1">Wasserhärte (°dH)</label>
            <input
              type="number"
              name="hardness"
              min="1"
      ...
      {/* Message */}
      <div>
        <label className="block text-sm font-semibold text-navy-900 mb-1.5">Nachricht *</label>
        <textarea
          name="message"
          required
          rows={4}
          ...
          className="w-full border border-slate-200 rounded-xl px-4 py-3 text-slate-900 placeholder:text-slate-400 focus:border-aqua-500 focus:ring-2 focus:ring-aqua-100 outline-none transition-all text-sm resize-none"
        />
      </div>
          ...
          <div className="grid lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-2 space-y-6">
              <AnimatedSection direction="left">
                <h2 className="text-3xl font-black text-navy-900 mb-2">Sprechen Sie uns an</h2>
                ...
                <div className="space-y-3">
                  <a
                    ...
                    className="flex items-center gap-4 bg-white border border-slate-100 hover:border-aqua-200 rounded-2xl p-4 group transition-all hover:shadow-card"
                  >
                    <div className="w-12 h-12 bg-aqua-50 group-hover:bg-aqua-100 rounded-xl flex items-center justify-center transition-colors">
                      <Phone className="w-5 h-5 text-aqua-600" />
                    </div>
                    <div>
                      <div className="font-bold text-navy-900">Telefon</div>
                      <div className="text-aqua-600 font-semibold text-sm">06073 743 3137</div>
                      <div className="text-slate-400 text-xs">Mo–Fr 9–17 Uhr</div>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div>
                      <div className="font-bold text-navy-900">E-Mail</div>
                      <div className="text-aqua-600 font-semibold text-sm">info@aquatimegmbh.de</div>
                      <div className="text-slate-400 text-xs">Antwort innerhalb 24h</div>
                    </div>
                  </a>
                  ...
                  <div className="flex items-center gap-4 bg-white border border-slate-100 rounded-2xl p-4">
                    ...
                    <div>
                      <div className="font-bold text-navy-900">Adresse</div>
                      <div className="text-slate-600 text-sm">Ziegelhüttenstraße 30</div>
                      <div className="text-slate-600 text-sm">64832 Babenhausen</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-emerald-50 border border-emerald-100 rounded-2xl p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-bold text-emerald-800 text-sm">Unser Versprechen</div>
            ...
            <AnimatedSection direction="right" delay={0.1} className="lg:col-span-3">
              <div className="bg-white rounded-3xl border border-slate-100 shadow-card p-8">
                <h3 className="text-2xl font-black text-navy-900 mb-1">Anfrage senden</h3>
                <p className="text-slate-500 text-sm mb-6">Kostenlos & unverbindlich. Wir antworten innerhalb von 24h.</p>
                <ContactForm />
              </div>
            </AnimatedSection>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 items-center justify-items-center">
            {[
              ...
              <div key={t.text} className="text-center">
                ...
                <div className="text-navy-900 font-black text-lg">{t.text}</div>
                <div className="text-slate-400 text-sm">{t.sub}</div>
              </div>
            ))}
          </div>
        </div>
